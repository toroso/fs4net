...
namespace fs4net.TestTemplates.Directory
{
    public abstract class LastAccessTimeFixture : PopulatedFileSystem
    {
        ...
        public void Create_Directory_Does_Not_Set_Parent_Parent_Directory_LastAccessTime()
        {
            ...
            newDir.Create();
            DateTime after = DateTime.Now.AddSeconds(1);
            Assert.That(ExistingLeafDirectory.ParentDirectory().LastAccessTime(), Is.Not.InRange(before, after));
        }
        ...
        public void Delete_File_Sets_Parent_Directory_LastAccessTime()
        {
            ...
            ExistingFile.Delete();
            DateTime after = DateTime.Now.AddSeconds(1);
            Assert.That(ExistingFile.ParentDirectory().LastAccessTime(), Is.InRange(before, after));
        }
        ...
        //    DateTime after = DateTime.Now.AddSeconds(1);
        //    Assert.That(ExistingFile.ParentDirectory().LastAccessTime(), Is.Not.InRange(before, after));
        //}
