...
namespace fs4net.Framework.Test.Combine
{
    ...
    public class RelativeFromFixture
    {
        ...
        {
            var dir = FileSystem.CreateDirectoryDescribing(@"c:\path\is");
        ...
        {
            var from = FileSystem.CreateDirectoryDescribing(@"c:\path\is\deep\deep\down");
            var to = FileSystem.CreateDirectoryDescribing(@"c:\path\is\different");
        ...
        {
            var from = FileSystem.CreateDirectoryDescribing(@"c:\path\on\one\drive");
            var to = FileSystem.CreateDirectoryDescribing(@"d:\path\on\other\drive");
        ...
        {
            var from = FileSystem.CreateDirectoryDescribing(@"c:\path\is\here\");
            var to = FileSystem.CreateDirectoryDescribing(@"c:\path\ends\with\backslash\");
        ...
        {
            var from = FileSystem.CreateDirectoryDescribing(@"c:\path\is\sleep\..\deep\deep\down");
            var to = FileSystem.CreateDirectoryDescribing(@"c:\myth\..\path\is\same\..\different");
        ...
        {
            var from = FileSystem.CreateDirectoryDescribing(@"c:\path\is\deep\deep\down");
            var to = FileSystem.CreateFileDescribing(@"c:\path\is\different.txt");
        ...
        {
            var from = FileSystem.CreateDirectoryDescribing(@"c:\path\on\one\drive");
            var to = FileSystem.CreateFileDescribing(@"d:\path\on\other\drive.txt");
            Assert.Throws<ArgumentException>(() => to.RelativeFrom(from));
        }
        ...
        {
            var from = FileSystem.CreateDirectoryDescribing(@"c:\path\is\sleep\..\deep\deep\down");
            var to = FileSystem.CreateFileDescribing(@"c:\myth\..\path\is\same\..\different.txt");
